...
void Shutdown()
{
    ...
    RenameThread("canadacoin-shutoff");
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 56667 or testnet: 56668)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 56666 or testnet: 56670)") + "\n" +
